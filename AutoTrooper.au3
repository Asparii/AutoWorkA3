...
Global $paused = True
Global $tickRate = 150000 ;time that it takes to burn all your force, if you're meditating, just set it to however long you want to meditate for.
Global $counter = 0
Global $xpCounter = 0
Global $lvCounter = 0
Global $meditateOnly = False ;True = no
Global $seconds = 0
...
$duckEnabled = True
$rightEnabled = False
$forceKey = 2 ;Force jump - this is the fastest, else you can set it to whatever you want.
    ...
    While $clickBot
        ...
        Do
            If $clickBot Then ;break the loop if the function gets called again
                ...
                if not $meditateOnly then
                    ControlSend("Garry's Mod", "", "", "f",1) ;jump - this is nice for leveling endurance
                EndIf
                If $jumpEnabled Then
                    ControlSend("Garry's Mod", "", "", "{SPACE}") ;jump - this is nice for leveling endurance
                EndIf
        ...
        If Not $meditateOnly Then
            ...
            Do
                ...
                Sleep(750)
                local $imageSearch = _ImageSearchArea('imageCheck1.png', 1, 0, 0, 1920, 1080, $x, $y, 25) ;if u have different resolution change the 1920x1080
            Until $imageSearch ;until imageSearch = true
            ...
            Sleep(55000) ;55 seconds -- Change if it doesnt fill up your Force bar completely.
